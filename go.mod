...
replace (
	// See https://github.com/cnabio/cnab-go/pull/294
	// bump-docker
	github.com/cnabio/cnab-go => github.com/carolynvs/cnab-go v0.23.5-0.20230202041631-200738064871
...
require (
	...
	github.com/docker/buildx v0.10.2
