...
// Cannot upgrade the to 1.17 because it makes go mod tidy fail on go.opentelemetry.io/otel/semconv: module go.opentelemetry.io/otel@latest found (v1.4.1), but does not contain package go.opentelemetry.io/otel/semconv
go 1.16
...
replace (
	...
	// bump-deps
	// See https://github.com/cnabio/cnab-to-oci/pull/119
	github.com/cnabio/cnab-to-oci => github.com/carolynvs/cnab-to-oci v0.3.0-beta4.0.20220315175405-90e37827b340
...
require (
	...
	github.com/cnabio/cnab-to-oci v0.0.0
