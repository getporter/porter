...
curl -fsSLo $PORTER_HOME/porter $PORTER_URL/latest/porter-darwin-amd64
...
curl -fsSLo $PORTER_HOME/mixins/exec/exec $PORTER_URL/mixins/exec/latest/exec-darwin-amd64
...
curl -fsSLo $PORTER_HOME/mixins/helm/helm $PORTER_URL/mixins/helm/latest/helm-darwin-amd64
...
curl -fsSLo $PORTER_HOME/mixins/azure/azure $PORTER_URL/mixins/azure/latest/azure-darwin-amd64
