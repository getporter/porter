...
`,
  ...
  porter uninstall`,
	...
	globalFlags.StringVar(&p.Config.ContextName, "context", "", "Name of the configuration context to use. When unset, Porter uses the current-context from the config file, falling back to the context named \"default\".")
