...
type ActionArguments struct {
	// Installation associated with the bundle.
	Installation storage.Installation

	// Run defines how to execute the bundle.
	Run storage.Run

	// BundleReference is the bundle to execute.
...
// Execute runs the specified bundle action.
func (r *Runtime) Execute(ctx context.Context, args ActionArguments) error {
	...
	default:
		...
		if currentRun.Action == "" {
			return log.Errorf("action is required")
		}
