...
const (
	...
	DependenciesV2ExtensionKey = PorterExtension + "." + DependenciesV2ExtensionShortHand
...
// HasDependenciesV2 returns whether or not the bundle has parameter sources defined.
