...
// GClient is a gRPC implementation of the sbom generator client.
type GClient struct {
...
// GServer is a gRPC wrapper around an SBOMGeneratorProtocol plugin
type GServer struct {
...
func (m *GServer) Generate(
	ctx context.Context,
	request *proto.GenerateRequest,
) (*proto.GenerateResponse, error) {
...
func (m *GServer) Connect(
	ctx context.Context,
	request *proto.SBOMConnectRequest,
) (*proto.SBOMConnectResponse, error) {
