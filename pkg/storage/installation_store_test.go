...
func generateInstallationData(t *testing.T, cp *TestInstallationProvider) {
...
func TestInstallationStorageProvider_Installations(t *testing.T) {
	for _, cp := range []*TestInstallationProvider{
		NewTestInstallationProvider(t),
		NewTestInstallationProviderSQL(t),
	} {
		t.Run(cp.Name, func(t *testing.T) {
			generateInstallationData(t, cp)
