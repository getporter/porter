...
Unless you specify additional flags during publish, the bundle is published to REGISTRY/BUNDLE_NAME:vBUNDLE_VERSION.
The publish command also prints our the full bundle reference when it completes.
