...
Plugins file is used for installing multiple porter plugins.
...
For more information, follow the documentation on [how to use plugins file with plugin installation](/cli/porter_plugins_install/).
```yaml
schemaType: Plugins
schemaVersion: 1.0.0
azure:
