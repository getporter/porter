...
|---------------|----------------|-----------------|
| Bundle        | (none)         | v0.38           |
| Bundle        | 1.0.0-alpha.1  | v1.0.0-alpha.12 |
...
| registry                         | false    | The OCI registry to use when the bundle is published.                                                                                          |
| reference                        | false    | The full reference to use when the bundle is published to an OCI registry.                                                                     |
...
| parameters.sensitive             | false    | Indicates where this parameter's value is sensitive and should not be logged.                                                                  |
...
| outputs.sensitive                | false    | Indicates where this output's value is sensitive and should not be logged.                                                                     |
